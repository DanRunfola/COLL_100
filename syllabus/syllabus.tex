...
\large Office Hours: MW 3-5P & Tue 2-4P, Thu 10-12P \\
\large 508.316.9109 &  \\
\end{tabular}
\end{table}
...
\large Name: Ben Dykstra, Ashley Napier  \\
\large Office: Blow Hall Room 150 (SSRMC) \\
\large Directions: \\
http://ssrmc.wm.edu/wp-content/uploads/2014/08/Finding-the-SSRMC.jpg \\
\large Office Hours: MW, 2-4PM; Thurs 9A-12P; Fri 2P-5P \\
\large Email: bfdykstra@email.wm.edu, anapier@aiddata.org \\
...
\textbf {\large Final Project:} The final project will be introduced the last few weeks, and will be due online at the conclusion of the scheduled final time (\textbf{Noon on December 10, 2015}). In this project, you will be assigned an open-ended question, and be asked to present a two to five page argument (including visualizations drawn from datasets) for why a certain course of action should - or should not - be taken. \\

\textbf {\large Important Dates:} The add and drop deadline this semester is Sep. 4, and withdrawal deadline is October 23. \\
...
\begin{itemize} \itemsep-0.4em
	\vspace{1mm}
	\item Wed, 8/26: Intro Lab - Testing the Waters
...
\begin{itemize} \itemsep-0.4em
	\vspace{1mm}
	\item Mon, 11/16; Wed 11/18: Final Project - Thinking like Machines
...
\begin{itemize} \itemsep-0.4em
	\vspace{1mm}
	\item Mon, 11/23: Final Project - Thinking Like Machines
...
\begin{itemize} \itemsep-0.4em
	\vspace{1mm}
	\item Mon, 11/30, Wed 12/2: Final Project Work Time 
...
\begin{itemize} \itemsep-0.4em
	\vspace{1mm}
	\item Final Project is Due by 12 Noon on December 10th.
	\vspace{1mm}
\end{itemize}
\end{minipage} \\
