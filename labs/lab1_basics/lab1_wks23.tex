...
\item To install the chloropleth package in R and create a map that statistically describes one or more American States county by county

\item To add dataset and create a spatial object in R and dissagregate that political subdivision into its component parts and explore the effect in terms of spatial statistical description 

\item To use analytic techniques in order to describe a demographic or economic characteristic of that political subdivision and graphically present that quantitative analysis as a map 

\end{enumerate}

% Enumerate the Laboratory Objectives

\large{\textbf{Software and Resources you will need or is helpful:}}

\begin{enumerate}[leftmargin=15mm]

\item The R Project for Statistical Computing otherwise known simply as R.  The R framework can be downloaded from https://www.r-project.org/

\item Quick R, an online resource developed by Rob Kabacoff, a statistical consultant and methodologist, that is purposed towards introducing students to the power of R.  http://www.statmethods.net/

\item Introduction to R, a pdf presentation created by Phil Spector, Applications Manager and Associate Adjunct Professor at Cal-Berkeley.  The pdf is more advanced than the the Quick-R online learning resource, but it covers many of R's basics with regard to functionality and emphasis on data management. https://www.stat.berkeley.edu/ \\ \textasciitilde spector/Rcourse.pdf
