...
The purpose of this laboratory is to think about ways to justify a decision using data that is openly accessible via a web browser.  In this case, you are going to be asked to illustrate that attending William and Mary really was the best choice (...which it was, but prove it!).  Further, you will produce your first data visualization using this information.
...
\item To create plots and a visualization that supports a decision using a given data set.
...
\item Attach a printed copy of your "visme" visualisation to this document, or submit it electronically.  How did you use it to illustrate William and Mary is an exceptional (or, crazy!) choice of where to get your degree?
...
Made it this far?  Want to try to go even farther?  Just want to learn?  Try any of the following to really impress us:
\begin{itemize}
